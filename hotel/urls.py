...
from .views import RoomListView,BookingListView,RoomDetailView,CancelBookingView,render_pdf_view,booking_render_pdf_view,SpaView,GalleryView,contact,base,RoomFullView, success, payment,EventBookView, ThingsView,places
